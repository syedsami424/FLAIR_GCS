...
if (!!window.EventSource) {
    ...
    source.addEventListener('accelerometer_readings', function (e) {
        ...
        var obj = JSON.parse(e.data);
        document.getElementById("accX").innerHTML = obj.pitch;
        document.getElementById("accY").innerHTML = obj.yaw;
        document.getElementById("accZ").innerHTML = obj.pitch;
        ...
        rocket.rotation.x = obj.pitch;
        rocket.rotation.y = obj.yaw;
        renderer.render(scene, camera);
    }, false);
}
